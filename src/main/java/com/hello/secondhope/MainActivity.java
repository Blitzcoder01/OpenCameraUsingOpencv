...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /** if (!OpenCVLoader.initDebug())
            Toast.makeText(getApplicationContext(),"unable to load opencv",Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(getApplicationContext(),"load opencv",Toast.LENGTH_SHORT).show();**/
        ...
        if (startYolo == true) {
            ...
            if (ArrayLength>=1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    Imgproc.putText(frame,cocoNames.get(idGuy) + " " + intConf + "%",box.tl(),Core.Formatter_FMT_PYTHON, 2, new Scalar(255,255,0),2);
